...
Sea $V = \{X_1, \ldots, X_n\}$ un conjunto de variables y sea $P(v)$ su distribución de probabilidad conjunta. 

Un conjunto $\text{PA}_j \subseteq V$ se dice que son los padres Markovianos de $X_j$ si $\text{PA}_j$ es el mínimo conjunto de variables predecesoras (es decir $X_i \in \text{PA}_j \rightarrow i < j$) tal que 
\end{defin}
