...
\end{teor}
\begin{proof}
Primero demostramos la implicación $\implies$. Primero lo demostramos para dos nodos cualesquiera. Sean $A$ y $B$ dos nodos del grafo que están d-separados. Entonces, o bien:
\begin{enumerate}
    \item hay 
\end{enumerate}
\end{proof}
