...
Sin embargo, observamos un gráfico como el de la Figura~\ref{fig:}
\begin{figure}
    \centering
    \includegraphics[width=0.5\linewidth]{simpson-scatter-normal.png}
    \caption{Datos de comparación de poder adquisitv}
