...
\begin{proof}
Como $A \subseteq \Omega$, $A = A \cap \Omega$ = $A \cap (\bigcup_{i \in \mathbb{N}} B_i)$. Por la propiedad distributiva de la unión y la intersección, tenemos que $\bigcup_{i \in \mathbb{N}} (B_i \cap A) = $
\end{proof}
