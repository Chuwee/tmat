...
Supongamos la situación $Z$ como `un interruptor ha sido presionado'. La variable $X$ es `el interruptor ha hecho un ruido' y la variable $Y$ es `la bombilla asociada al interruptor está encendida'. De inmediato vemos la estructura causal
