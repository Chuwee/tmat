...
En el análisis de nuestra observación nos damos cuenta de que hemos comparado individuos de distintos países de forma agregada. Si separamos los datos por nacionalidad vemos un resultado distinto. Se ve en la Figura~\ref{fig:segregated-scatter}
