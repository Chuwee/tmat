...
\begin{proof}
Construiremos la sucesión en la que los primeros nodos son aquellos que no tienen flechas entrantes, en cualquier orden. A continuación añadiremos los descendientes del primer nodo cuyos descendientes no estén ya en la sucesión. Por definición, cualquier descendiente de un nodo está por delante de ese nodo en dicha sucesión, por lo que hemos construido el orden topológico.
\end{proof}
