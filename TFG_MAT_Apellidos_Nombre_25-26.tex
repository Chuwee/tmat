...
\begin{enumerate}
    ...
    \item $V$ es un conjunto de variables endógenas, es decir, que su causa se contempla dentro del modelo. Su causa viene determinada por variables en $V \cup U$.
    \item $F$ es un conjunto de ecuaciones estructurales de acuerdo a lo definido en 
\end{enumerate}
\end{defin}
