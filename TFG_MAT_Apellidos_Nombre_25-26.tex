...
\end{lema}
\begin{proof}
Supongamos que no. Entonces, escojamos al azar un nodo del grafo. Como tiene flechas entrantes, podemos ir hacia atrás todo lo que queramos. Como el grafo tiene nodos finitos, por el principio del palomar volveremos a llegar a alguno de los nodos visitados.
\end{proof}
