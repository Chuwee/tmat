...
De manera intuitiva, es útil contar con variables aleatorias para definir relaciones causales, pues podemos expresar las relaciones causales como transformaciones numéricas. Surge de manera natural tratar causas entre variables aleatorias como dependencias por relaciones funcionales. Así pues, diremos que una variable está causada por otra \textbf{si existe una relación funcional estructurada}

\begin{defin}[Ecuación estructural]
Sea $X_i$ una variable de un modelo causal 
\end{defin}
