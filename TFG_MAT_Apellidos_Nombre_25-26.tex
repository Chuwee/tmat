...
Sea $M = \langle U, V, F\rangle$ un SCM con DAG asociado $G$. En el contexto de la Definición~\ref{def:padres-markovianos}, decimos que las variables predecesoras de $V_j$ son aquellas variables del grafo que forman parte de los \textbf{no descendientes} de $V_j$ ($\text{ND}_j$
\end{defin}
