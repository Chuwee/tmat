...
Esto causó los datos que vemos en la tabla, donde el remedio se enfrentaba en su mayoría a casos de mujeres. En definitiva, y proponiendo un grafo similar al de~\ref{fig:dag_causal}, podemos concluir que 
