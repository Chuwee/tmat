...
Más coloquialmente, supongamos que interpretamos la variable $X$ como `el suelo está mojado'. Si $Y$ es `ha llovido' y $U$ son las variables . Intuitivamente podríamos decir
...
\end{cases}
\end{equation*}
De esta manera, si ha llovido, el suelo estará mojado a no ser que exista algún valor que no consideremos que asigne el valor.
