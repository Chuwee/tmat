...
De igual manera, si un observador que no puede ver la bombilla oye que el interruptor emite un sonido, asumirá que la bombilla se ha encendido (a menos que exista una anomalía en el circuito conductor entre el interruptor y la bombilla, otra variable exógena $U_X$).
