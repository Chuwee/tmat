...
\appendix 
\chapter{Definiciones básicas de grafos}


\begin{defin}
Decimos que $G = (V, E)$ es el grafo compuesto por los vértices en $V$ y las aristas en $E$.
\begin{itemize}
    \item $V = \{x_1, x_2, \ldots, x_n \mid n \in \mathbb{N}\}$ es un conjunto de $n$ vértices.
    \item $E \subseteq V \prod V$
\end{itemize} y $E \subseteq \{(x_i, x_j) \mid i, j \in \mathbb{N}, i, j \leq n\}$ es el conjunto de las aristas. Diremos que hay una arista entre $x_i$ y $x_j$ si $(x_i, x_j) \in E$.
\end{defin}
