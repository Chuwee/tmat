...
Considerando estos datos, lo más sensato sería retirar de inmediato la medicación, pues causa una tasa de curación menor. Sin embargo, nuevos datos revelan que \textbf{las mujeres son más vulnerables a la enfermedad que los hombres}.
