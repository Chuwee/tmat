...
Si un camino no es d-separado, diremos que es d-conexo. Intuitivamente, un camino bloqueado no permite el paso de dependencia condicional entre los extremos del camino. 
...
% Dashed curved arrow from Z3 to Z1
\draw[dashed, -{Stealth[scale=1.2]}, thick, bend left=50] (Z3) to (Z1);
