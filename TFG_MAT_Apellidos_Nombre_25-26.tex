...
Podríamos aventurarnos a formular afirmaciones sobre la dependencia de las variables. En el caso de la cadena, podríamos decir que (con falta de rigor) $Z$ depende de $Y$ condicionalmente  
