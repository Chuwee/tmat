...
\begin{proof}
Vamos por inducción sobre el número de nodos en el grafo $n$. Si $n = 0$ el conjunto vacío es la enumeración trivial.

Supongamos que todos los grafos con menos de $n$ nodos tienen un orden topológico. Sea $G = (V, E)$ un grafo acíclico dirigido con $n$ nodos. Consideramos uno de sus nodos sin aristas, llamémoslo $X_1$. Consideramos el grafo $G' = (V - \{X_1\}, E')$ donde $E'$ es el conjunto de aristas sin las entrantes o salientes de $X_1$. El grafo $G$ es acíclico y dirigido pues quitar nodos no crea ciclos, y tiene $n-1$ nodos.
