...
Supongamos que todos los grafos con menos de $n$ nodos tienen un orden topológico. Sea $G$ un grafo acíclico dirigido con $n$ nodos. Consideramos uno de sus nodos sin aristas 
\end{proof}
