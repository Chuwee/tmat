...
Y diremos que $f_i$ es la ecuación que determina el valor de $X_i$ dados $\text{PA}_i$ y $\text{U}_i$. De manera coloquial, diremos que las variables de \text{PA}_i
\end{defin}

Aquí utilizamos dos conjuntos de variables distintos
