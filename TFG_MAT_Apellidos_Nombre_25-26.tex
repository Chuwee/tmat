...
\begin{enumerate}
    ...
    \item $F$ es un conjunto de ecuaciones estructurales $\{f_1, f_2, \ldots, f_n\}$ de acuerdo a lo definido en \ref{def:eq-estructural}. Cada $f_i$ determina el valor de $V_i$ de acuerdo a los conjuntos $\text{PA}_i$ y $U_i$ definidos. En este contexto, $\text{PA}_i \subseteq (V - \{V_i\}) $ es el conjunto de variables endógenas de las que depende $V_i$. 
\end{enumerate}
\end{defin}
