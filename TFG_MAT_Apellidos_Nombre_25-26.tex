...
Como ya veníamos anticipando, podemos exponer el isomorfismo entre un grafo y un modelo estructural causal. Sea $M = \langle U, V, F\rangle$ un SCM. Definimos su estructura causal asociada (o DAG asociado) como $G = \langle V \cup U, E\rangle$, donde $E = \{(C, V_i)\}$
