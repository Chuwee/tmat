...
Diremos que una distribución es compatible con un grafo $G$ si factoriza de acuerdo al 
\end{defin}
...
\begin{teor}
Los conjuntos $X$ e $Y$ son d-separados por un conjunto $Z$ en un DAG $G$, si y solo si las variables en $X$ son independientes de las variables en $Y$ condicionando por $Z$ en toda distribución compatible con $G$.
\end{teor}
