...
\end{lema}
\begin{proof}
Supongamos un grafo acíclico dirigido con $n$ nodos en el que todo nodo tiene por lo menos una flecha entrante. Escogemos un nodo cualquiera de dicho grafo, y lo llamamos $V_n$. Al tener por lo menos una flecha entrante, podemos escoger uno de los nodos que apunta a él, y lo llamamos $V_{n-1}$. Continuamos sucesivamente. Si en algún momento tocamos un nodo que ya hemos recorrido, entonces hemos terminado. Si no, entonces después de $n$ iteraciones llegaremos a una lista de nodos recorridos que como máximo puede tener longitud $n$.

Como podemos repetir este proceso cuanto queramos (pues todo nodo tiene por lo menos una flecha entrante)
